"""
Django settings for compoMarket2 project.
...
SECRET_KEY = 'django-insecure-3yvv5-sza())fp5%6zg(5*4(-mb)qs1z-25&qnu)%bqu%r(^!u'
...
ROOT_URLCONF = 'compoMarket2.urls'
...
WSGI_APPLICATION = 'compoMarket2.wsgi.application'
